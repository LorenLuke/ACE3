...
_far_avg = _far_avg vectorMultiply (1/(count _listFar));
_near_avg = _near_avg vectorMultiply (1/(count _listNear));
_tol_avg = _tol_avg vectorMultiply (1/(count _listTol));
